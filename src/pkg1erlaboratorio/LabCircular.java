...
public class LabCircular extends javax.swing.JFrame {
    ...
    public LabCircular() {
        ...
        ptr = null;
        ptr2 = null;
        JOptionPane.showMessageDialog (null, "Para agregar en la última posición de la lista circular se debe ingresar\n una posicion que exceda en una unidad al número de elementos de la lista");
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (!(pos.getText().isEmpty())) {
            ...
            if (cont == posi) {
                ...
                JOptionPane.showMessageDialog(null, "No se encuentra esa posicion");
            }
